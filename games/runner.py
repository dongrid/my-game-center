...
def side_scroller_game():
    ...
    const enemies = [
        {x: 600, y: 320, w: 30, h: 30, vx: -2, alive: true},
        {x: 1200, y: 320, w: 30, h: 30, vx: -2, alive: true},
        {x: 1500, y: 320, w: 30, h: 30, vx: -2, alive: true}
    ];
    
    const goal = {x: 1800, y: 250, w: 40, h: 100};
    const keys = {};
